...
public class ProductOrangeAdapter extends RecyclerView.Adapter<ProductOrangeAdapter.ProductOrangeHolder> implements Filterable{
    ...
    public ProductOrangeAdapter(ArrayList<Product> productArrayList, Context context) {
    ...
    @NonNull
    @Override
    public ProductOrangeHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        View view = inflater.inflate(R.layout.item_product, parent, false);

        return new ProductOrangeHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ProductOrangeHolder holder, int position) {
    ...
    public class ProductOrangeHolder extends RecyclerView.ViewHolder {
        ...
        public ProductOrangeHolder(View itemView) {
            super(itemView);
        ...
        public void bind(Product product) {
            ...
            imgView_index.setColorFilter(ContextCompat.getColor(context, R.color.orange));
        }
